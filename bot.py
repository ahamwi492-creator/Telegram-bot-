...
print("🚀 بدء تشغيل بوت الترندينغ المحترف - تشغيل مجدول...")
...
# التشغيل الرئيسي - تشغيل واحد ثم إنهاء
if __name__ == "__main__":
    ...
    try:
        ...
        start_message = f"""
🤖 **بدء تشغيل بوت الترندينغ المحترف - التشغيل المجدول**
...
"""
        ...
        try:
            error_msg = f"❌ خطأ في البوت: {str(e)[:100]}... سيتم إعادة المحاولة في التشغيل القادم"
